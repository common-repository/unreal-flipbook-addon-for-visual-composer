<?php
  ...
  function pro_notice_render($post) {
    ?>
      <div class="notice notice-warning">
        <p>
          This is <b>Lite Version</b>. To get more functions use <a href="http://3dflipbook.net/download-vc" target="_blank"><b>Pro Version</b></a>.
        </p>
        <p>
          <b>Pro Version</b> has custom control settings (keys binding, disabling the control buttons,  ...), skins and <a href="http://3dflipbook.net/download-vc" target="_blank">much more</a>.
        </p>
      </div>
    <?php
  }
  ...
  function manual_metabox_render($post) {
    ...
    <div class="fb3d">
      <ul class="manual">
        <li>
          <span class="dashicons dashicons-book"></span> <a href="http://3dflipbook.net/vc-user-manual" target="_blank"><?php _e('User Manual', POST_ID) ?></a>
        </li>
        <li>
        ...
        <li>
          <span class="dashicons dashicons-format-chat"></span> <a href="http://3dflipbook.net/support?product=3" target="_blank"><?php _e('Support Forum', POST_ID) ?></a>
        </li>
        <li>
